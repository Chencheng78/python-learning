...
filename = json.dumps({'size': 28, 'sha256': '4e1bd481104cbcd1d863040722aa8c226a91c4ac8552d60fb79d31eebd529ce5'})
filename = filename.encode('ascii')
upload_file = {'config.py': (filename, open('config.py', 'rb'), 'application/octet-stream')}
# Replace with requests extension.

# m = MultipartEncoder(
#     fields={'config.py': (StringIO(json.dumps({'size': 28, 'sha256': '4e1bd481104cbcd1d863040722aa8c226a91c4ac8552d60fb79d31eebd529ce5'})), open('config.py', 'rb'), 'application/octet-stream')}
# )
# headers['content-type'] = m.content_type
# print m.to_string()

req_upload = requests.post(writedir_url, headers=headers, files=upload_file)
print (req_upload.content)
...
# with open('config哇哇哇1.py', 'wb') as f:
...
# '''
# m4 = MultipartEncoder(
#     fields={'a_0_0.jpg': json.dumps({'op': 'remove'}), 'a_0_1.jpg': json.dumps({'op': 'remove'})}
# )
#
